        ...
        <div className={styles.itemOuter + (props.isUserMessage ? " " + styles.userMessage : "")}>
            <div className={styles.item}>
                <div className={styles.item__top}>
                    <img className={styles.item__top__avatar} src={'https://www.kindpng.com/picc/m/78-786207_user-avatar-png-user-avatar-icon-png-transparent.png'} alt='avatar'/>
                    <div className={styles.item__top__name}>{props.userName}</div>
                </div>
                <div className={styles.item__content}>{props.messageText}</div>
